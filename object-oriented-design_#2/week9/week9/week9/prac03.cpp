...
//위 코드에서는 Manager, Intern, Janitor 타입의 오브젝트들을 관리하기 위해, 
//각 오브젝트와 동일한 타입을 가지는 배열(managelist, internlist, janitorlist) 을 생성하였고,
//각 오브젝트의 생성자를 통해 배열에 삽입
//생성한 객체를 통해 오브젝트에 맞는 print 를 출력한다.
